...
class DES_View(object):
    ...
    def __init__(self):
        ...
        self.fig_dict = {
                            'Line Plot':(ce.line_plot,{}),'Plot Dots(discrete plot)':(ce.discrete_plot,{}),
    ...
    def figure_list_draw(self,values):
        ...
        if self.have_selected_graph(values) :
            choice = values['-LISTBOX-'][0]                 
            func_tuple = self.fig_dict[choice]                        
            kwargs = func_tuple[1]
            
            func = func_tuple[0]
            
            fig = func(**kwargs)                                    # Get figure
    ...
    def layout_screen(self):
        ...
        self.components['deploy_chat'] = sg.Button(button_text="Chat",size=(10, 2))
        self.controls += [deploy_chat_button.accept]
        ...
        col_listbox = [
                        ...
                        [self.components['deploy_chat'],self.components['text_spacer'],self.components['uploader'],self.components['new_des'],self.components['select_file'],self.components['exit_button'] ]
                      ]   
    ...
    def create(self):
        ...
        # Create a form 
        if self.layout != [] :
            self.window =sg.Window('Data Analysis Platform', self.layout, grab_anywhere=False, finalize=True, resizable=True)
